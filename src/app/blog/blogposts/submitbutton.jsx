...
export default function Submitbutton(){
    ...
    <button class="button-bird">
        ...
        <svg version="1.1" className="feather" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 75 38" style={{ enableBackground: 'new 0 0 75 38' }} xmlSpace="preserve">
        <g>
